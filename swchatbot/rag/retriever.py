...
from swchatbot.utils import FileOperationTool
from swchatbot.utils import QueryTracker
...
class CacheRetriever:
    def __init__(self, max_len: int = 4):
        ...
        # 将嵌入模型权重数据类型从 float32 转换为 float16，加快推理速度
